...
module.exports.ALL = [
	new DDClass('Barbarian',
		...
		.attr('weapons', ddData.weapons.map(x => x.name))
	...
	new DDClass('Bard', 
		...
		.attr('weapons', ddData.weapons.simple.map(x => x.name).concat(['hand crossbows', 'longswords', 'rapiers', 'shortswords']))
	...
	new DDClass('Cleric',
		...
		.attr('armor', ['light armor', 'medium armor', 'shields'])
		.attr('weapons', ddData.weapons.simple.map(x => x.name))
	...
	new DDClass('Monk',
		...
		.attr('armor', [])
		.attr('weapons', ddData.weapons.simple.map(x => x.name).concat('shortswords'))
