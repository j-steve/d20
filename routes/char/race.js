...
router.get('/', function(req, res, next) {
	res.locals.ddclasses = [
		...
		new DDClass('Elf', 'http://3.bp.blogspot.com/-TcHKFJ0j71w/VN03zkTuuOI/AAAAAAAAGa4/GLAo-HEZxWw/s1600/fed2bcceeacf55240793a6c2070c12ce.jpg', "Elves are a magical people of otherworldly grace, living in the world but not entirely part of it. They live in places of ethereal beauty, in the midst of ancient forests or in silvery spires glittering with faerie light, where soft music drifts through the air. Elves love nature and magic, art and artistry, music and poetry, and the good things of the world.")
			.decide('Subrace')
